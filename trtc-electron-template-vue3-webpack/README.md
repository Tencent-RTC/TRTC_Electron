...
Modify `App.vue` file to show SDK version. Also you call invoke other [SDK API](https://web.sdk.qcloud.com/trtc/electron/doc/en-us/trtc_electron_sdk/index.html) to explore more features.
```vue
<!-- App.vue -->
<template>
...
To make the SDK version information clear, we delete some vue code automatically generated by `@vue/cli`. When you run the project again, you will see the SDK version as below image.
